package cn.monitor.core.tags.html.resolver;
...
public class HtmlComponentDTDEntityResolver implements EntityResolver, Serializable {
	...
	private static final String HOP_DYNAMIC_STATEMENT = "http://www.hadoop1024.com/dtd/";
	...
	public InputSource resolveEntity(String publicId, String systemId) {
		...
		if (systemId != null) {
			...
			if (systemId.startsWith(HOP_DYNAMIC_STATEMENT)) {
				LOGGER.debug(
						"recognized hop html component namespace attempting to resolve on classpath under cn/monitor/core/tags/html/dtd/");
	...
	private InputSource resolveOnClassPath(String publicId, String systemId, String namespace) {
		...
		String path = "cn/monitor/core/tags/html/dtd/" + systemId.substring(namespace.length());
