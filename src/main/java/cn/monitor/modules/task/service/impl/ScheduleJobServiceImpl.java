package cn.monitor.modules.task.service.impl;

import cn.monitor.core.common.service.impl.CommonServiceImpl;
import cn.monitor.core.quartz.QuartzManager;
import cn.monitor.modules.task.entity.ScheduleJob;
import cn.monitor.modules.task.mapper.ScheduleJobMapper;
import cn.monitor.modules.task.service.IScheduleJobService;
import cn.monitor.modules.task.utils.ScheduleJobUtils;
...
public class ScheduleJobServiceImpl extends CommonServiceImpl<ScheduleJobMapper, ScheduleJob>
	...
	public void updateCron(String jobId) throws SchedulerException {
		...
		if (cn.monitor.core.quartz.data.ScheduleJob.STATUS_RUNNING.equals(scheduleJob.getJobStatus())) {
	...
	public void changeStatus(String jobId, String cmd) throws SchedulerException {
		...
		if ("stop".equals(cmd)) {
			...
			scheduleJob.setJobStatus(cn.monitor.core.quartz.data.ScheduleJob.STATUS_NOT_RUNNING);
		} else if ("start".equals(cmd)) {
			scheduleJob.setJobStatus(cn.monitor.core.quartz.data.ScheduleJob.STATUS_RUNNING);
